...
export default function Navbar() {
  ...
  // Keep this if you use it for something else, or remove if unused
  const openTerminal = () => {
    setIsOpen(false);
  ...
  // --- THE FIX IS HERE ---
  // This now sends the EXACT signal that ContactSection is listening for
  const openContact = () => {
    setIsOpen(false);
    // Matches the listener in ContactSection.tsx
    window.dispatchEvent(new Event('trigger-contact-modal')); 
  };
